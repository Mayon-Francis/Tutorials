In the Last three Articles, (Find them here if you missed them, Article 1, Article 2, Article 3) We went deep into what ipfs is and how to use it. Now Let’s talk about why should we actually be using ipfs.
